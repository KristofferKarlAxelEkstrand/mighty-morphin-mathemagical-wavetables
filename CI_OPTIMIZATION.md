...
This document explains the CI workflow optimizations implemented to reduce GitHub Actions minutes usage while maintaining code quality and test coverage. These changes are designed for FOSS projects operating on the free tier with limited CI budget.
